...
# [![Coverage](https://codecov.io/gh/ITensor/FunctionImplementations.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/ITensor/FunctionImplementations.jl)
...
# {CCQ_LOGO}
#
# FunctionImplementations.jl is supported by the Flatiron Institute, a division of the Simons Foundation.
...
#=
```julia
julia> Pkg.add("FunctionImplementations")
```
=#
